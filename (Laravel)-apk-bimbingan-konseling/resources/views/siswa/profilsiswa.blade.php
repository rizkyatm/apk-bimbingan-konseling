            ...
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                  ...
                  <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Profil Siswa</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Profil Siswa</h6>
              </nav>
                  ...
                  <div id="edit-form" style="display: none;" class="pt-3">
                    <form class="mx-4" action="/updateprofilsiswa/{{$user->siswa->id}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label for="edit-nip" class="form-label">NISN</label>
                            <input type="text" name="nisn" class="form-control" id="edit-nip" value="{{ $user->nisn_nip }}">
                          </div>
                        </div>
                      </div>
                      <div class="row">
