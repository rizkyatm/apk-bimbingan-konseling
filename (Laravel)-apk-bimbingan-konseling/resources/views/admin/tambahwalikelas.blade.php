            ...
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                  ...
                  <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Wali Kelas</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Tambah Wali Kelas</h6>
              </nav>
              ...
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header pb-0 d-flex align-items-center">
                    <h6 class="flex-grow-1">Form Wali Kelas</h6>
                  </div>
                  <div class="card-body px-4 pt-2 pb-2">
                    <form action="/Admin/InsertWaliKelas" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <div class="row mb-3">
                          <div class="col-md-6">
                            <label for="nama" class="form-label">Nama</label>
                            <input type="text" class="form-control" name="namagurukelas" id="namagurukelas">
                          </div>
                          <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-md-6">
                            ...
                            <span style="color: red; font-size: 12px; position: absolute;">*password default adalah 123*</span>
                          </div>
                        </div>
                          <div class="row mb-3">
                            <div class="col-md-6">
