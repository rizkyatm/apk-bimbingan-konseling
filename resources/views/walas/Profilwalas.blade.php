            ...
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                  ...
                  <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Profil Wali Kelas</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Profil Wali Kelas</h6>
              </nav>
              ...
              <div class="col-4" >
                ...
                <div class="profile-picture pt-6 pl-2 pr-5 d-block align-items-center text-center" style="margin: 0 auto;  ">
                  <div class="foto-container" style="margin: 0 auto; width: 200px; height: 200px;">
                    <img src="{{ asset('fotowalikelas/'.$user->walikelas->foto) }}" alt="Foto Pengguna" id="foto">
                  </div>
                  <h5 class="mt-2" style="font-weight: bold; font-size: 18px;">{{ $user->walikelas->namagurukelas }}</p>
                  <p class="" style="font-size: 13px; margin-top: -10px;">
                    Wali kelas
              ...
              <div class="col-8" >
                <div class="card mb-4" style="height: auto;">
                  ...
                  <div class="card-body" id="profile-info">
                    ...
                    <div class="card-text-row">
                        <div class="d-flex mb-1">
                          ...
                          <p>{{ $user->walikelas->namagurukelas }}</p>
                        </div>
                        <div class="d-flex mb-1">
                        ...
                        <div class="d-flex mb-1">
                            ...
                            <h6 class="" style="width: 2%;">:</h6>
                            <p>{{ $user->walikelas->jeniskelamin }}</p>
                        </div>
                        <div class="d-flex mb-1">
                            <h6 style="width: 30%;">Tempat Lahir</h6>
                            <h6  style="width: 2%;">:</h6>
                            <p>{{ $user->walikelas->tempatlahir }}</p>
                        </div>
                        <div class="d-flex mb-1">
                          <h6 style="width: 30%;">Tanggal Lahir</h6>
                          <h6 class="" style="width: 2%;">:</h6>
                          <p>{{ $user->walikelas->tanggallahir }}</p>
                        </div>
                    </div>
                  ...
                  <div id="edit-form" style="display: none;" class="pt-3">
                    <form class="mx-4" action="/updateprofilwalikelas/{{$user->walikelas->id}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="row">
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label for="edit-nama" class="form-label">Nama</label>
                            <input type="text" name="namagurukelas" class="form-control" id="edit-nama" value="{{ $user->walikelas->namagurukelas }}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-3">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="tempatlahir" id="tempatlahir" value="{{$user->walikelas->tempatlahir}}">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="tanggallahir" id="tanggallahir" name="tanggallahir" value="{{$user->walikelas->tanggallahir}}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <select class="form-select" name="jeniskelamin" id="jeniskelamin">
                              <option selected>{{$user->walikelas->jeniskelamin}}</option>
